...
class TestDLHelpers(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_annotation_overall.context = {'assignmentId': 'assignee_assignment_id'}
    ...
    def test_cleanup_annots_by_score(self, mock_delete):
        ...
        cleanup_annots_by_score(scores, annots_to_keep=['test_entity_id'], logger=mock_logger)
    ...
    def test_get_best_annotator_by_score(self):
        ...
        self.assertEqual(result, 0.8)  # Should return the highest score for ANNOTATION_OVERALL
